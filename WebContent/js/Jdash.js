...
// ランダム値生成
	...
	//ボタン生成
		var buttonA = new Button(btnStr[btr_Ai],"dark",20,25,12);
	var buttonB = new Button(btnStr[btr_Bi],"dark",20,25,12);
	var buttonC = new Button(btnStr[btr_Ci],"dark",20,25,12);
	var buttonD = new Button("<span id = 'so'>送信</span>","light",30,30);


//	setFont('20px');
	var buttonA1 = new Button("<span id = 'aaaa'>"+btnStr1[btr_nAi]+"</span>",red,100,100,20);
	var buttonB1 = new Button("<span id = 'aaaa'>"+btnStr1[btr_nBi]+"</span>",red,100,100,20);
	var buttonC1 = new Button("<span id = 'aaaa'>"+btnStr1[btr_nCi]+"</span>",red,100,100,20);
	var buttonD1 = new Button("<span id = 'aaaa'>"+btnStr1[btr_nDi]+"</span>",red,100,100,20);
            ...
            //クッション
				...
				function input(){
					...
					if(input_flag==1){
				 	...
				 	//アルファベットボタン
				 	function button(A){
						addButton(buttonD,270,200,A,btr_A);
				 		addButton(buttonC,200,200,A,btr_A);
				 		addButton(buttonB,150,200,A,btr_A);
				 		addButton(buttonA,100,200,A,btr_A);
               		}
               	...
               	function button_int(A){
				 	addButton(buttonA1,145,175,A,btr_B);
				 	addButton(buttonB1,270,175,A,btr_B);
				 	addButton(buttonC1,395,175,A,btr_B);
				 	addButton(buttonD1,520,175,A,btr_B);
				}
		} //room
      		   		...
      		   		function buttonOntuch(){
					   	...
					   	function buttonOntuch1(){
							...
							case 1 :
								...
								buttonA1.text="<span id = 'aaaa'>"+btnStr1[btr_nAi]+"</span>";
								break;
							case 2 :
								btr_nBi=checkInd1(btr_nBi);
								buttonB1.text="<span id = 'aaaa'>"+btnStr1[btr_nBi]+"</span>";
								break;
							case 3 :
								btr_nCi=checkInd1(btr_nCi);
								buttonC1.text="<span id = 'aaaa'>"+btnStr1[btr_nCi]+"</span>";
								break;
							case 4 :
								btr_nDi=checkInd1(btr_nDi);
								buttonD1.text="<span id = 'aaaa'>"+btnStr1[btr_nDi]+"</span>";
								break;
							}
				...
				//  ボタン追加 addButton(ボタンインスタンス,x座標,y座標,画面追加[0]/否追加[1])
					function addButton(button,x,y,flag,btr_A){
						if(flag==0&&btr_A==0){
